...
- `additional-input` (optional): Extra context or instructions to pass as a separate invocation of `/speckit.constitution`
...
### 5. Feed Each Page into /speckit.constitution
